    ...
    <div class="container">
        <div class="main-card mb-3 card">
            <div class="card-body">
                ...
                {!! Form::open(['method' => 'post', 'action' => 'Admin\ProductsController@storeFromRestorant', 'files' =>
                true]) !!}
                <div class="container">
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::select('branches[]', $branches, [], ['id' => 'branch-id', 'class' => 'form-control',
                        'multiple']) !!}
                    </div>
                ...
                `
                                <div class="options-cont-radious" id="options_container_rempove_${optionCounter}">
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <input type="number" class="form-control" name="group[${groupCounter}][options][${optionCounter}][price]" required placeholder="سعر الأختيار">
                                                 </div>
                                            </div>
                                         </div>
                                        </div> 
