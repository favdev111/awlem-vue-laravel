    ...
    <div class="parts form container">
        <div class="main-card mb-3 card">
            <div class="card-body">
                ...
                @endif
                {!! Form::open(['method' => 'post', 'action' => 'Admin\RestorantsController@store', 'files' => true]) !!}
                <div class="container">
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            {!! Form::text('name', null, ['required' => 'required','class' => 'form-control', 'placeholder' => __('restorant.name')])
                            !!}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            {!! Form::select('user_id', $users, null, ['required' => 'required','class' => 'form-control', 'placeholder' =>
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            {!! Form::select('category_id', $categories, null, ['required' => 'required','class' => 'form-control', 'placeholder' =>
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::select('types[]', $types, [], ['required' => 'required','id' => 'type-id', 'class' => 'form-control', 'multiple'])
                        !!}
                    </div>

                    <div class="form-group">
                        <strong>{{ __('restorant.areas') }}</strong>
                        {!! Form::select('areas[]', $newreRegionArr, [], ['required' => 'required','id' => 'area-id', 'class' => 'form-control', 'multiple'])
                        !!}
                    </div>

                    <div class="form-group">
                        <label style="width:150px" for="name">{{ __('restorant.featured') }}</label>
                        {!! Form::checkbox('featured', null, 1, ['class' => 'form-control', 'data-toggle' => 'toggle',
                        'data-onstyle' => 'primary']) !!}
                    </div>

                    <div class="form-group">
                        <label style="width:150px" for="name">{{ __('متاح') }}</label>
                        {!! Form::checkbox('accepted', null, 1, ['class' => 'form-control', 'data-toggle' => 'toggle',
                        'data-onstyle' => 'primary']) !!}
                    </div>
                            ...
                            $('.featured_meals_container').prepend(
                                `
                                        <div class="col-md-3" id="featerd_meal_${featured_counter}">
                                            ...
                                            <i class="fas fa-times-circle" style="position: absolute;cursor: pointer;color: #D80200;top: 9px;left: 20px;font-size: 19px;"
                                        onclick="removeFeaturedMealInput(${featured_counter})"></i>
                                        </div>
                                        `
                            );
                            featured_counter++;
