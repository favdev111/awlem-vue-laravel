...
@section('content')
    ...
    <div class="parts form container">
        <div class="main-card mb-3 card">
            <div class="card-body">
                <h5 class="card-title">{{ __('region.edit_region') }}</h5>
                @if (count($errors) > 0)
                ...
                @endif
                {!! Form::open(['method' => 'patch', 'action' => ['Admin\RegionsController@update', $region->id], 'files' => true]) !!}
                <div class="container">
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            {!! Form::text('name', $region->name, ['class' => 'form-control', 'placeholder' => __('region.name')])
                            !!}
                        </div>
                    </div>
