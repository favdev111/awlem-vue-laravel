...
@section('content')
    ...
    <div class="parts form container">
        <div class="main-card mb-3 card">
            <div class="card-body">
                <h5 class="card-title">{{ __('area.edit_area') }}</h5>
                @if (count($errors) > 0)
                ...
                @endif
                {!! Form::open(['method' => 'patch', 'action' => ['Admin\AreasController@update', $area->id], 'files' =>
                true]) !!}
                <div class="container">
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            {!! Form::select('region_id', $regions, $area->region_id, ['class' => 'form-control',
                            'placeholder' => __('area.region')]) !!}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            {!! Form::text('name', $area->name, ['class' => 'form-control', 'placeholder' =>
                            __('area.name')]) !!}
                        </div>
                    </div>
