...
<body>
    <style>
        ...
        .scrollbar-sidebar::-webkit-scrollbar { width: 0 !important }
    </style>
    <div class="app-container app-theme-white body-tabs-shadow fixed-sidebar fixed-header fixed-footer">
        ...
        <div class="app-main">
            ...
            @elseif(Auth::user()->hasRole('Restorant'))
            @include('admin.includes.sideRestorant');
            @elseif(Auth::user()->hasRole('Branch'))
            @include('admin.includes.sideBranch');
            @else
            @include('admin.includes.side');
            @endif
    ...
    <script type="text/javascript" src="{{ url('./Panel/adminAssets/bootstrap-material-datetimepicker.js') }}"></script>
